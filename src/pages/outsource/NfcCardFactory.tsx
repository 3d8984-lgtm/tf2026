...
const FONT_OPTIONS: FontOption[] = [
  ...
  // ===== English commercial-free fonts (Google Fonts / SIL OFL · Apache 2.0) =====
  {
    ...
    pdfFontUrl: (w) => `https://cdn.jsdelivr.net/npm/@fontsource/inter/files/inter-latin-${[300,400,500,600,700,800,900].reduce((p,c)=>Math.abs(c-w)<Math.abs(p-w)?c:p,400)}-normal.ttf`,
  },
  {
    id: "roboto",
    ...
    pdfFontUrl: (w) => `https://cdn.jsdelivr.net/npm/@fontsource/roboto/files/roboto-latin-${[300,400,500,700,900].reduce((p,c)=>Math.abs(c-w)<Math.abs(p-w)?c:p,400)}-normal.ttf`,
  },
  {
    id: "montserrat",
    ...
    pdfFontUrl: (w) => `https://cdn.jsdelivr.net/npm/@fontsource/montserrat/files/montserrat-latin-${[300,400,500,600,700,800,900].reduce((p,c)=>Math.abs(c-w)<Math.abs(p-w)?c:p,400)}-normal.ttf`,
  },
  {
    id: "poppins",
    ...
    pdfFontUrl: (w) => `https://cdn.jsdelivr.net/npm/@fontsource/poppins/files/poppins-latin-${[300,400,500,600,700,800,900].reduce((p,c)=>Math.abs(c-w)<Math.abs(p-w)?c:p,400)}-normal.ttf`,
  },
  {
    id: "oswald",
    ...
    pdfFontUrl: (w) => `https://cdn.jsdelivr.net/npm/@fontsource/oswald/files/oswald-latin-${[300,400,500,600,700].reduce((p,c)=>Math.abs(c-w)<Math.abs(p-w)?c:p,400)}-normal.ttf`,
  },
  {
    id: "bebas-neue",
    ...
    pdfFontUrl: () => `https://cdn.jsdelivr.net/npm/@fontsource/bebas-neue/files/bebas-neue-latin-400-normal.ttf`,
  },
  {
    id: "playfair-display",
    ...
    pdfFontUrl: (w) => `https://cdn.jsdelivr.net/npm/@fontsource/playfair-display/files/playfair-display-latin-${[400,500,600,700,800,900].reduce((p,c)=>Math.abs(c-w)<Math.abs(p-w)?c:p,400)}-normal.ttf`,
  },
  {
    id: "space-grotesk",
    ...
    pdfFontUrl: (w) => `https://cdn.jsdelivr.net/npm/@fontsource/space-grotesk/files/space-grotesk-latin-${[300,400,500,600,700].reduce((p,c)=>Math.abs(c-w)<Math.abs(p-w)?c:p,400)}-normal.ttf`,
  },
  {
    id: "dm-sans",
    ...
    pdfFontUrl: (w) => `https://cdn.jsdelivr.net/npm/@fontsource/dm-sans/files/dm-sans-latin-${[400,500,700].reduce((p,c)=>Math.abs(c-w)<Math.abs(p-w)?c:p,400)}-normal.ttf`,
  },
  {
    id: "archivo",
    ...
    pdfFontUrl: (w) => `https://cdn.jsdelivr.net/npm/@fontsource/archivo/files/archivo-latin-${[300,400,500,600,700,800,900].reduce((p,c)=>Math.abs(c-w)<Math.abs(p-w)?c:p,400)}-normal.ttf`,
  },
  {
    id: "jetbrains-mono",
    ...
    pdfFontUrl: (w) => `https://cdn.jsdelivr.net/npm/@fontsource/jetbrains-mono/files/jetbrains-mono-latin-${[300,400,500,600,700,800].reduce((p,c)=>Math.abs(c-w)<Math.abs(p-w)?c:p,400)}-normal.ttf`,
  },
];

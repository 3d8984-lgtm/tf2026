...
export default function Machines() {
  ...
  const machines = [
    ...
    { id: "B-3", name: lang === "ko" ? "중량검사기 B-3" : "重量检测机 B-3", status: "running", speed: "150", uptime: "99.1%", total: 31000, error: "-", lastComm: "14:36:56" },
    { id: "B-4", name: lang === "ko" ? "택배 포장기 B-4" : "快递包装机 B-4", status: "running", speed: "78", uptime: "88.5%", total: 18300, error: "-", lastComm: "14:36:55" },
    { id: "B-5", name: lang === "ko" ? "송장 부착기 B-5" : "运单贴附机 B-5", status: "running", speed: "110", uptime: "95.7%", total: 35680, error: "-", lastComm: "14:37:04" },
  ];
